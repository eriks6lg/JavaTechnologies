...
public class FigureTest {
    ...
    public void testRotateClockwise() throws Exception {
        ...
        assertEquals(Block.SIZE, block.coordinateX);
        assertEquals(Block.SIZE * 2, block.coordinateY);

        double x = block.getX();
        double y = block.getY();
        int coordinateX = block.coordinateX;
        int coordinateY = block.coordinateY;

        figure.rotateClockwise();
        assertEquals(Block.SIZE * -2, block.getX(), PRECISION);
        assertEquals(Block.SIZE, block.getY(), PRECISION);
        assertEquals(coordinateX - x + block.getX(), block.coordinateX, PRECISION);
        assertEquals(coordinateY - y + block.getY(), block.coordinateY, PRECISION);
    ...
    public void testMove() throws Exception {
        ...
        assertEquals(0 * Block.SIZE, block1.coordinateX);
        assertEquals(0 * Block.SIZE, block1.coordinateY);
        assertEquals(0 * Block.SIZE, block2.coordinateX);
        assertEquals(1 * Block.SIZE, block2.coordinateY);
        assertEquals(0 * Block.SIZE, block3.coordinateX);
        assertEquals(2 * Block.SIZE, block3.coordinateY);
        assertEquals(1 * Block.SIZE, block4.coordinateX);
        assertEquals(2 * Block.SIZE, block4.coordinateY);
        ...
        assertEquals(1 * Block.SIZE, block1.coordinateX);
        assertEquals(0 * Block.SIZE, block1.coordinateY);
        assertEquals(1 * Block.SIZE, block2.coordinateX);
        assertEquals(1 * Block.SIZE, block2.coordinateY);
        assertEquals(1 * Block.SIZE, block3.coordinateX);
        assertEquals(2 * Block.SIZE, block3.coordinateY);
        assertEquals(2 * Block.SIZE, block4.coordinateX);
        assertEquals(2 * Block.SIZE, block4.coordinateY);
        ...
        assertEquals(2 * Block.SIZE, block1.coordinateX);
        assertEquals(0 * Block.SIZE, block1.coordinateY);
        assertEquals(2 * Block.SIZE, block2.coordinateX);
        assertEquals(1 * Block.SIZE, block2.coordinateY);
        assertEquals(2 * Block.SIZE, block3.coordinateX);
        assertEquals(2 * Block.SIZE, block3.coordinateY);
        assertEquals(3 * Block.SIZE, block4.coordinateX);
        assertEquals(2 * Block.SIZE, block4.coordinateY);
        ...
        assertEquals(2 * Block.SIZE, block1.coordinateX);
        assertEquals(1 * Block.SIZE, block1.coordinateY);
        assertEquals(2 * Block.SIZE, block2.coordinateX);
        assertEquals(2 * Block.SIZE, block2.coordinateY);
        assertEquals(2 * Block.SIZE, block3.coordinateX);
        assertEquals(3 * Block.SIZE, block3.coordinateY);
        assertEquals(3 * Block.SIZE, block4.coordinateX);
        assertEquals(3 * Block.SIZE, block4.coordinateY);
        ...
        assertEquals(2 * Block.SIZE, block1.coordinateX);
        assertEquals(3 * Block.SIZE, block1.coordinateY);
        assertEquals(2 * Block.SIZE, block2.coordinateX);
        assertEquals(4 * Block.SIZE, block2.coordinateY);
        assertEquals(2 * Block.SIZE, block3.coordinateX);
        assertEquals(5 * Block.SIZE, block3.coordinateY);
        assertEquals(3 * Block.SIZE, block4.coordinateX);
        assertEquals(5 * Block.SIZE, block4.coordinateY);
        ...
        assertEquals(2 * Block.SIZE, block1.coordinateX);
        assertEquals(2 * Block.SIZE, block1.coordinateY);
        assertEquals(2 * Block.SIZE, block2.coordinateX);
        assertEquals(3 * Block.SIZE, block2.coordinateY);
        assertEquals(2 * Block.SIZE, block3.coordinateX);
        assertEquals(4 * Block.SIZE, block3.coordinateY);
        assertEquals(3 * Block.SIZE, block4.coordinateX);
        assertEquals(4 * Block.SIZE, block4.coordinateY);
        ...
        assertEquals(-1 * Block.SIZE, block1.coordinateY);
        assertEquals(1 * Block.SIZE, block2.coordinateX);
        assertEquals(0 * Block.SIZE, block2.coordinateY);
        assertEquals(1 * Block.SIZE, block3.coordinateX);
        assertEquals(1 * Block.SIZE, block3.coordinateY);
        assertEquals(2 * Block.SIZE, block4.coordinateX);
        assertEquals(1 * Block.SIZE, block4.coordinateY);
    ...
    public void testMeltFigure() throws Exception {
        ...
        int x1 = block3.coordinateX;
        int y1 = block3.coordinateY;
        int x2 = block4.coordinateX;
        int y2 = block4.coordinateY;
        ...
        assertEquals(x1, block3.coordinateX);
        assertEquals(y1, block3.coordinateY);
        assertEquals(x2, block4.coordinateX);
        assertEquals(y2, block4.coordinateY);
